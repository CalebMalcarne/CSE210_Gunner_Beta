...
from game_.services.video_service import VideoService 


class RaylibVideoService(VideoService):
    """ A Raylib implementation of VideoService."""

    def __init__(self, title = "", width = 1080, height = 800, color = BLACK):
        self._title = title
        self._width = width
        self._height = height
        self._color = color
    ...
    def draw_line(self, startPosX, startPosY,endPosX, endPosY, Color, color):
        pyray.draw_line(startPosX, startPosY, endPosX, endPosY, Color, color)