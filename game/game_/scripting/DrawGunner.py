...
class drawgunner(Action):
    ...
    def execute(self, cast, script, callback):
        ...
        line_end_y_a = 480
        line_end_x_b = 0
        self._video_service.draw_line(line_start_x, line_start_y, line_end_x_a, line_end_y_a, [255,255,255,255], [255,255,255,255])
        self._video_service.draw_line(line_start_x, line_start_y, line_end_x_b, line_end_y_a, [255,255,255,255], [255,255,255,255])
